                            ...
                            <div>
                                ...
                                <Accordion>
                                    ...
                                    <Accordion.Collapse eventKey="1" className={"dashboard-collapse"}>
                                        <div>
                                            ...
                                            <Link to="/admin-template/list" className={"dashboard-links"}>Template List</Link>
                                        </div>
                                    </Accordion.Collapse>
                                </Accordion>
                                ...
                                <Accordion>
                                    ...
                                    <Accordion.Collapse eventKey="2" className={"dashboard-collapse"}>
                                        <div>
                                            <Link to="/addConference" className={"dashboard-links"}>Add Conference</Link> <br/>
                                            <Link to="/conferenceList" className={"dashboard-links"}>Conference List</Link>
                                        </div>
                                    </Accordion.Collapse>
                                </Accordion>
