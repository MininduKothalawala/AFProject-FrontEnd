    ...
    render() {
        ...
        return (
            <div className={"reg-form-main-div"}>
                <h4 className={"reg-form-title"}>Researcher Registration</h4>
                <Form onSubmit={this.handleSubmit}>
                    <Form.Group controlId={"regName"}>
                        <Form.Label className={"reg-form-label"}>Name</Form.Label>
                        <Form.Control className={"reg-form-input"} type={"text"} name={"name"}
                    ...
                    <Form.Group controlId={"regEmail"}>
                        ...
                        <Form.Control className={"reg-form-input"} type={"email"} name={"email"}
                    ...
                    <Form.Group controlId={"regMobile"}>
                        ...
                        <Form.Control className={"reg-form-input"} type={"text"} name={"mobile"}
